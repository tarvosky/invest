                ...
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Tax Documents:1040 Schedule C</h4>
                        ...
                        <div class="alert alert-info" style="margin:15px" >
                            <p>Click 
                                ...
                                <a href="{{ asset('watermark/1040SCHEDULEC.png') }}" data-lightbox="gallery-1" data-title="TAX">
                                    1040 Schedule C
                                </a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"> <a class="btn btn-primary float-right" data-toggle="tooltip"
                                                    ...
                                                    href="{{ asset('tax-documents/create') }}"> Place Order <i class="fas fa-plus"></i>   </a> </th>
                                        </tr>
                                    </thead>
                                    <tbody>
