...
@section('content')
            ...
            <div class="row">
                ...
                <form action="{{ route('tax-documents.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{ $data->business_description }}" name="business_description"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{ $data->instruction_code }}" name="instruction_code"
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Enter SSN or EIN (Make sure you write the one selected) </label>
                            <input id="birth_date" maxlength="9" type="text" value="{{$value}}" name="security_value"
                            placeholder="eg 232-22-4372 or 31-2432434"  class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input  type="text" value="{{ $data->total_income }}" name="total_income" placeholder="10000.50"
                                class="form-control" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Total Expenses ($ expense should be lower than total income)</label>
                            <input  type="text" value="{{ $data->total_expenses }}" name="total_expenses" placeholder="5000.50"
                                class="form-control" >
                        </div>
                    </div>
