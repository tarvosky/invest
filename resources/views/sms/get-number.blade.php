...
@section('content')
                        ...
                        <div class="widget-body">
                         ...
                         <table class="table  table-bordered table-responsive" width="100%">
                            ...
                            <tr>
                                ...
                                <th> 
                                        <span style="font-size:18px;padding-right:10px"  id="vernumber"></span> 
            ...
            setTimeout("countDownTimer()",1000);
                ...
                function requestCode() {
                        ...
                        let  number = document.getElementById("vernumber");
                        let  changenumber = number.innerHTML;
                        ...
                        $.ajax({  
                           ...
                           success: function (data) {
                               ...
                               const num = data.data;
                               let num_container="";
                               updateDatabase(changenumber,service,country,num,"use"); 
                         ...
                         $.ajax({  
                           ...
                           success: function (data) {
                               ...
                               let num = data.data;
                                myFunction(-22);
                                document.getElementById("status").innerHTML = "completed";
                                updateDatabase('44785849393',"1","Uk",num,"use"); 
        ...
        function updateDatabase(number,service,country,num,state) {
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                ...
                $.ajax({
                        ...
                        type: 'post',
                        data: {_token: CSRF_TOKEN,number:number,sms_services_id:service,country:country,web_code:num,state:state,user_id:user_id},
                        dataType:'json',
                    success: function (data) {
                    console.log(data);
                        },
                ...
                // GET NUMBER AND LOADING
                $(document).ready(function() {
                        document.getElementById("loading").style.display = "inline-block";
                        document.getElementById("hidecopy").style.display = "none";
                           $.ajax({  
                           type: "GET",
                           url:"{{ asset('sms-ajax/get-number/'. $service->id .'/'. $data['country'])}}",
                           success: function (data) {
                               document.getElementById("loading").style.display = "none";
                               document.getElementById("hidecopy").style.display = "inline-block";
                               console.log(data);
                               console.log('passed');
                               let num = "+"+data.data;
                             $("#vernumber").html(num);
