...
<body>
    ...
    <table width="100%" cellspacing="" cellpadding="0" border="0" class="smsize">
        <tr>
            ...
            <td style="padding:0px;" align="right"> <img width="120" height="60" style="margin:0;padding:0"
                    src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('logos/bbva.png'))) }}">
            </td>
        </tr>
    ...
    <table width="100%" cellspacing="" cellpadding="0" border="0" class="smsize">
        ...
        <tr>
            ...
            <td width="40%" style="padding:0px;padding:50px" align="left">

                <h2>Contacting Us</h2>
                <small>Available by phone 24/7 </small><br />
                <small>Phone: 1-800-266-7277</small><br />
                <small>Online: bbvausa.com</small><br />
                <small>Write BBVA</small><br />
                <small>Customer Service</small><br />
                <small> P.O. Box 10566</small><br />
                <small> Birmingham, AL 35296</small><br />
    ...
    <div>
        <p class="mdsize">What are you saving for? We can help! Start the new year with a plan that includes one of our
            great savings
            options. Learn more at bbvausa.com/savings.</p>
    </div>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" class="sssize">
                <tr>
                    ...
                    <td width="11%"
                        ...
                        <?php echo ($key + 1) % 4 != 0 ? cal_bal_by_key($statement->opening_balance, $key +
                        1, $transactions_ordinary) : ''; ?>
                    </td>
                </tr>
            </table>
    ...
    <table width="100%" class="sssize" cellspacing="0" cellpadding="0" border="0" style="margin-top:50px" class="table">
        ...
        <tr>
            ...
            <td width="50%" style="padding-left:10px;border-left: 1px solid #666;padding-top:0px;">
                ...
                <p>In case of errors or questions about your Electronic Transfers, write to BBVA, Operations Compliance
                    Support, P.O. Box 10566, Birmingham, AL 35296. Or simply call your local customer service number
                ...
                <p>he interest charge is computed using your annual percentage rate divided by 365 or,
                    ...
                    BBVA business days are Monday through Friday, excluding holidays.</p>
                ...
                <p>If you think your statement is wrong, or if you need more information about a transaction on your
                    statement, write your issue on a separate document and send it to Bankcard Center, P.O. Box 2210,
                    Decatur, AL 35699-0001. Telephone inquires may be made by calling your local BBVA branch listed on
                ...
                <p style="padding-top:10px">
                    BBVA and BBVA Compass are trade names of BBVA USA, a member of the BBVA Group. BBVA USA, Member
                    FDIC.
                </p>
