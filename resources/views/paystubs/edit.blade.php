...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Edit Paystub</h4>
                ...
                <form action="{{ route('paystubs.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input value="{{ $data->company_street }}" name="company_street"
                            placeholder="ex. P.O.Box 12323 town avenue" class="form-control" type="text">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputZip">Company City</label>
                            <input placeholder="City (ex.Cleveland)" value="{{ $data->company_city }}" name="company_city" class="form-control"
                                type="text">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputEmail3">Company Zip</label>
                            <input   type="text"  value="{{ $data->company_zip }}" name="company_zip"
                                class="form-control" >
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text"placeholder="Matrix Manufacturing INC"  value="{{ $data->name }}" name="name"
                                class="form-control" id="inputEmail4">
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputZip">Employee SSN</label>
                                <input maxlength="9" placeholder="123456789" value="{{ $data->ssn }}" name="ssn" class="form-control"
                                    type="text">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input value="{{ $data->annual_pay }}" name="annual_pay" class="form-control"
                                    type="text">
                            </div>

                            <div class="form-group col-md-3">
                                <label for="inputZip">Pay Date</label>
                                <input id="pay_date" value="{{ $data->pay_date }}" name="pay_date" class="form-control"
                                    type="text">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select  name="pay_type" class="form-control" >
                                 <option value="{{$data->pay_type}}">{{$data->pay_type}}</option>
