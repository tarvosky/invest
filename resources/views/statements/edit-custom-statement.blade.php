...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Edit Custom Statement</h4>
                ...
                @endif
                        ...
                        <form action="{{ route('statement.custom.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" value="{{ $data->address }}" name="address" placeholder="P.O. Box 10566"
                                    class="form-control">
                            </div>
                        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="inputZip">Bank Name(only if customize is selected )</label>
                <input name="bank_name" value="{{ $data->bank_name }}" placeholder="North Trust Bank Plc"
                    class="form-control" type="text" >
           </div>

            <div class="form-group col-md-4">
                <label for="inputZip">Bank Website (optional)</label>
                <input name="bank_website" value="{{ $data->bank_website }}"
                    class="form-control" placeholder="e.g www.northtrustbank.com" type="text">
           </div>

            <div class="form-group col-md-4">
                <label for="inputZip">Bank Phone</label>
                <input name="bank_phone"  placeholder="e.g 1800-222-111" value="{{ $data->bank_phone }}"
                    class="form-control" type="text">
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input type="text"  value="{{ $data->bank_address }}" name="bank_address" placeholder="P.O. Box 10566"
                    class="form-control">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input name="bank_zip" placeholder="e.g 1032" type="number" value="{{ $data->bank_zip }}"
                    class="form-control" type="text">
           </div>
