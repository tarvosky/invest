...
<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="widget p-md clearfix">
					<div>
						<h3 class="widget-title">SSN Background Instruction</h3>
            <ul>
    ...
    <div class="row">
            ...
            <div class="text-center mt-5 mt-5">
              <a class="btn btn-danger btn-lg" href="{{ asset('socials')}}"> Finish >> </a>
          </div>
					</div>
			...
			<div class="col-md-12">
				<div class="widget widget-pie-chart">
					<header class="widget-header">
						<h4 class="widget-title">Select SSN Background</h4>
          </header>
...
$(document).ready(function() {
         $.ajax({  //create an ajax request to display.php
          type: "GET",
          url: "{{ asset('socials/get-selected-background/'. $social->id )}}",       
  ...
  function reply_click(id,image)
  {
     ...
     $.ajax({
            url:"{{ asset('socials/update-selected-background/'. $social->id )}}",
            type: 'post',
