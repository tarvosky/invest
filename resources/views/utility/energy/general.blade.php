...
<table width="100%" cellspacing="" cellpadding="0" border="0" class="mdsize">
    ...
    <tr>
        ...
        <td width="4%"></td>
        <td width="48%" style="background:#6b6b6b;color:white" align="right">
            <span style="">
...
<table width="100%" cellspacing="" cellpadding="0" border="0" class="mdsize" style="margin-bottom:5px">
    <tr>
        <td width="50%" style="padding:0px;" align="left" >
            <span style="padding-top:0px;font-size:32px;color:#6b6b6b;">
                Your energy bill
            </span>
        </td>
...
<div style=";border-top: #6b6b6b solid thin" class="mdsize">
</div>
           ...
           <table><tr>
            ...
            <table width="100%" border="0" class="mdsize">
                <tr>
                    ...
                    <td width="90%" style="border-bottom: #000000 solid 2px">
                ...
                <tr>
                    ...
                    <td width="90%" style="border-bottom: #000000 solid 2px"><strong>Visit pseg.com/myaccount </strong> to access your account anytime</td>
                </tr>      
                <tr>
                    <td width="10%" ><img  width="30" height="20"
                        style="margin:0;padding:0"
                       src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('utilities/energy/8.png'))) }}"></td>
                    <td width="90%" style="border-bottom: #000000 solid 2px"><strong>Text us</strong>. Register for MyAlerts by texting <strong>REG</strong> to 4PSEG(47734) > Text <strong>OUT</strong> to report an outage.</td>
                </tr> 
                <tr>
                    <td width="10%" ></td>
                    <td width="90%" style="border-bottom: #000000 solid 2px"><strong></strong><img  width="15" height="15"
                        style="margin:0;padding:0"
                ...
                <table width="100%" cellspacing="" cellpadding="0" border="0" style="padding-top:20px;">
                    ...
                    <tr>
                        <td width="50%" style="padding:0px;" align="left">
                                ...
                                <div style="border:  10px solid  #e6e6e6">

                                    <span style="padding:10px;font-size:20px;color:#6b6b6b;font-weight:bold">
                                        Snapshot of what you owe
                                    </span>
                                    <div style="padding:10px 0px;">See page 2 for details</div>
                                    <table class="sssize" width="100%" border="0">
                                        <tr>
                                            <td align="left" width="80%" style="border-bottom: 1px dashed #000000">Balance remaining from your last bill</td>
                                            <td width="20%" style="border-bottom: 1px dashed #000000">$0.00</td>
                                        </tr>
                                        <tr>
                                            <td align="left"  width="80%" style="border-bottom: 1px dashed #000000">This month’s charges and credits</td>
                                            <td width="20%" style="border-bottom: 1px dashed #000000"> ${{ number_format($info['amount'],2) }}</td>   
                                        </tr>   
                                        <tr>
                                ...
                                <div style="background: #e6e6e6; padding:10px;">
                                    <div style="font-size:18px;color:#6b6b6b;">How much energy you’re using</div>
                                    <table width="100%" border="0">
                                        <tr>
                                            <td><img 
                                               ...
                                               <br> <span style="color:#6b6b6b">Electric</span>
                                            </td>
                                            <td>You <br> used</td>
                                        ...
                                        <tr>
                                            ...
                                            <br> <span style="color:#6b6b6b">Gas</span>
                                            </td>
                                            <td>You <br> used</td>
...
<div style="padding-top:30px;text-align:center;font-family: cedarville-font-family;">{{ strtoupper($info['account_no'])}} 0000{{ rand(100000,999999)}} 00000{{ rand(100000,999999)}}</div>
   ...
   {{-- ------------------------------------------------------------------------------------------------------------------ --}}
    ...
    <table width="100%" class="mdsize" border="0" style="margin-top:60px;">
        <tr>
            <td width="50%">
                <div style="padding-top:10px;font-size:20px;color:#6b6b6b;">
                    Balance remaining from your last bill
                </div>
                <table width="100%" class="sssize" border="0" style="margin-top:10px;">
                    <tr>
                        <td width="10%"></td>
                        <td width="70%" style="border-bottom: 1px dashed #000000">PSE&G balance from last bill</td>
                        <td  width="20%" style="border-bottom: 1px dashed #000000" align="left" >${{ number_format($info['balance_remain_sec_page'],2)}}</td>
                    </tr>
                    <tr>
                        <td> <span style="color:#6b6b6b;font-weight:bold;font-style:italic;font-size:8px">Less</span></td>
                        <td style="border-bottom: 1px dashed #000000"> Payment received February 19, 2021 – thank you!</td>
                        <td style="border-bottom: 1px dashed #000000" align="left" > -${{ number_format($info['balance_remain_sec_page'],2)}}</td>
                    </tr>  
                    <tr>
                        <td></td>
                ...
                <div style="padding-top:0px;font-size:21px;color:#6b6b6b;margin-top:10px;">
                    This month’s charges and credits
                </div>
                <table width="100%" class="sssize" border="0" style="margin-top:10px;">
                    <tr>
                        <td width="10%"></td>
                        <td style="border-bottom: 1px dashed #000000" width="70%">Gas charges - PSE&G</td>
                        <td  style="border-bottom: 1px dashed #000000" width="20%" align="right" >${{ number_format($info['r1'],2)}}</td>
                    </tr>
                    <tr>
                        <td> <span style="color:#6b6b6b;font-weight:bold;font-style:italic;font-size:8px">Plus</span></td>
                        <td style="border-bottom: 1px dashed #000000"> Electric charges - PSE&G</td>
                        <td  style="border-bottom: 1px dashed #000000" align="right" > ${{ number_format($info['r2'],2)}}</td>
                    </tr>  
                    <tr>
                        <td> <span style="color:#6b6b6b;font-weight:bold;font-style:italic;font-size:8px">Plus</span></td>
                        <td style="border-bottom: 1px dashed #000000"> WorryFree Protection Plan charge </td>
                        <td style="border-bottom: 1px dashed #000000"  align="right" > ${{ number_format($info['r3'],2)}}</td>
                    </tr> 
                    <tr>
                        <td> <span style="color:#6b6b6b;font-weight:bold;font-style:italic;font-size:8px">Plus</span></td>
                        <td style="border-bottom: 1px dashed #000000"> Community Solar Credit    </td>
                        <td  style="border-bottom: 1px dashed #000000"align="right" > -${{ number_format($info['r4'],2)}}</td>
                    </tr> 
                    <tr>
                        <td> </td>
                ...
                <div style="background:#ccc;margin-top:10px;" >
                    <table width="100%" class="mdsize" border="0" >
                        <tr>
                            <td> <span style="color:#6b6b6b;font-weight:bold;">Total amount due by {{ ucwords($info['pay_date_short'])}}</span></td>
            ...
            <td width="10%"></td>
            <td width="40%">
               <div style="margin-top:10px;padding: 10px;border:1px solid #000;text-align:justify">
   ...
   <table width="100%"   border="0" >
    <tr>
        <td><div style="color:#6b6b6b; padding-top:20px"> IT’S <strong>YOUR BILL</strong>. HOW YOU PAY IS <strong>YOUR CHOICE.</strong></div></td>
   </tr>                            
</table>
...
<td style="text-align:justify">
   ...
   {{-- ------------------------------------------------------------------------------------------------------------------ --}}
    ...
    <table width="100%" class="mdsize" border="0" style="margin-top:70px;">
        <tr>
            <td width="50%">
                ...
                <table width="100%" class="mdsize" border="0" >
                   ...
                   src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('utilities/energy/9a.png'))) }}"></td>
                        <td><div style="padding-top:0px;font-size:18px;color:#6b6b6b;font-weight:bold">
                ...
                <table width="100%" class="sssize" border="0" style="margin-top:10px;">
                    ...
                    <tr>
                        <td width="10%"><span style="color:#6b6b6b;font-weight:bold;font-style:italic;font-size:8px">Less</span></td>
                ...
                <div style="padding-top:0px;font-size:14px;color:#6b6b6b;margin-top:10px;font-weight:bold">
                    Delivery charges
                </div>
                <table width="100%" class="sssize" border="0" >
                    <tr>
                ...
                <table width="100%" class="sssize" border="0" >
                        <tr>
                         ...
                         <tr>
                          <td style="color:#6b6b6b;font-weight:bold">How much gas are you using?</td>
                         </tr>
                    <tr>
            ...
            <td width="10%"></td>
            <td width="40%" >
               <div style="padding: 10px;border:1px solid #000;text-align:justify;margin-top:10px;">
               ...
               <div style="margin-top:20px;padding: 10px;border:1px solid #6b6b6b;text-align:justify">
                    ...
                    <td width="50%">
                        ...
                        <table width="100%" class="sssize" border="0" >
                           ...
                           Total electric charges</th>
                                ...
                                <th  align="right"  style="color:#6b6b6b;font-weight:bold;" width="20%">${{ number_format($info['electric_total'],2)}}</th>
                            </tr>                      
                        </table>
