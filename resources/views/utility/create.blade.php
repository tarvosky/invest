                ...
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">   Create Utility</h4>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text"placeholder="Doe"  value="{{ old('last_name') }}" name="last_name"
                                    class="form-control" id="inputEmail4">
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="ein_issued_date" value="{{ old('billing_date') }}" name="billing_date" class="form-control"
                                    type="text">
                            </div>
                              <div class="form-group col-md-6">
                               ...
                               <select name="type"  class="form-control">
                                <option value="">Select</option>
                                 ...
                                 <option value="directv">DIRECTV USA</option>
                                  <option value="spectrum">SPECTRUM USA</option>
                                  <option value="xfinity">XFINITY USA</option>
