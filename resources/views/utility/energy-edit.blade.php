...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">   Edit Energy</h4>
                ...
                @endif
                 ...
                 <form action="{{ route('utility.energy.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')             
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"placeholder="John"  value="{{ $data->name }}" name="name"
