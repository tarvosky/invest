...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Enter EIN Verification letter</h4>
                ...
                @endif
                    ...
                    <form method="POST" action="{{ route('einletter.store') }}">
                        @csrf
                        <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input  type="text" value="{{ old('ein') }}" name="ein"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="ein_issued_date" value="{{ old('ein_issued_date') }}" name="ein_issued_date" class="form-control"
                                    type="text">
                            </div>
                        </div>
