                ...
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">EIN Verification Letter</h4>
                        ...
                        <div class="alert alert-info" style="margin:15px" >
                            <p>Click 
                                ...
                                <a href="{{ asset('watermark/EINletter.png') }}" data-lightbox="gallery-1" data-title="EIN LETTER">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"> <a class="btn btn-primary float-right" data-toggle="tooltip"
                                                    ...
                                                    href="{{ asset('einletter/create') }}"> Place Order <i class="fas fa-plus"></i>   </a> </th>
                                        </tr>
                                    </thead>
                                    <tbody>
