...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">   EDIT LEASE AGREEMENT</h4>
                ...
                @endif
                <form action="{{ route('rental.update.la', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')  
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Tenant Last Name</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input placeholder="eg 24" maxlength="2"  value="{{ $data->month}}" name="month" class="form-control"
                                    type="text">
                            </div>

                           <div class="form-group col-md-6">
                                <label for="inputZip">Agreement Date to Begin</label>
                                <input id="beginning_date" value="{{ $data->beginning_date }}" name="beginning_date" class="form-control"
                                    type="text">
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text"placeholder="25000.00"  value="{{ $data->amount }}" name="amount"
                                class="form-control" id="inputEmail4">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">County</label>
                            <input type="text"placeholder="a.g Jacksonville"  value="{{ $data->county }}" name="county"
                                class="form-control" id="inputEmail4">
                        </div>
                    </div>
