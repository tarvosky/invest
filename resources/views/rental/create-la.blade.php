...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">   CREATE LEASE AGREEMENT</h4>
                ...
                @endif
                    ...
                    <form method="POST" action="{{ route('rental.post.la') }}">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Tenant First Name</label>
                                <input type="text"placeholder="John "  value="{{ old('first_name') }}" name="first_name"
                                    class="form-control" id="inputEmail4">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Tenant Last Name</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Month term(number only)</label>
                                <input placeholder="eg 12" type="number" maxlength="2"  value="{{ old('month') }}" name="month" class="form-control"
                                    type="text">
                            </div>
                           <div class="form-group col-md-6">
                                <label for="inputZip">Agreement Date to Begin</label>
                                <input id="beginning_date" value="{{ old('beginning_date') }}" name="beginning_date" class="form-control"
                                    type="text">
                            </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Total Rent (Amount number only)</label>
                            <input type="text" type="number" placeholder="25000"  value="{{ old('amount') }}" name="amount"
                                class="form-control" id="inputEmail4">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">County</label>
                            <input type="text"placeholder="a.g Jacksonville"  value="{{ old('county') }}" name="county"
                                class="form-control" id="inputEmail4">
                        </div>
                    </div>
