...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">   EDIT LATE RENT</h4>
                ...
                @endif
                        ...
                        <form action="{{ route('rental.update.lr', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')              
                            <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text"placeholder="Chase Bank"  value="{{ $data->bank_name }}" name="bank_name"
                                    class="form-control" id="inputEmail4">
                            </div>                           
                            <div class="form-group col-md-4">
                                <label for="inputEmail4">Account Number</label>
                                <input type="text"placeholder="102939892221"  value="{{ $data->account_number }}" name="account_number"
                                    class="form-control" id="inputEmail4">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputEmail4">Routing Number</label>
                                <input type="text"placeholder="232322"  value="{{ $data->routing_number }}" name="routing_number"
                                    class="form-control" id="inputEmail4">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input id="rent_fee" placeholder="2600.00"  value="{{ $data->rent_fee }}" name="rent_fee" class="form-control"
                                    type="text">
                            </div>

                           <div class="form-group col-md-3">
                                <label for="inputZip">Late Fees</label>
                                <input  placeholder="260.80"  value="{{ $data->late_fee }}" name="late_fee" class="form-control"
                                    type="text">
                            </div>

                            <div class="form-group col-md-3">
                                <label for="inputZip">Months Late in Rent (number only)</label>
                                <input  placeholder="e.g 8" maxlength="2"  value="{{ $data->month }}" name="month" class="form-control"
                                    type="text">
                            </div>
