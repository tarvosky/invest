...
@section('content')
            ...
            <div class="row">
                ...
                @endif
                        ...
                        <form action="{{ route('divorce-certificate.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')  
                         ...
                         <div class="form-row">
                               ...
                               <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $data->court_house_name }}" name="court_house_name"
                                placeholder="eg MINNESOTA COURT HOUSE" class="form-control" id="inputEmail4">
                            </div>

                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Court County</label>
                            <input id="birth_date" type="text" value="{{ $data->county }}"  name="county"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                         ...
                         <input type="text" value="{{ $data->husband_name }}" name="husband_name"
                         placeholder="eg Mr Ben Johnson" class="form-control" id="inputEmail4">
                     </div>

                 <div class="form-group col-md-6">
                     <label for="inputPassword4">Wife Full Name</label>
                     <input id="birth_date" type="text" value="{{ $data->wife_name }}"  name="wife_name"
            ...
            <div class="form-group col-md-6">
                ...
                <input id="divorce_date" value="{{ $data->divorce_date }}" name="divorce_date" class="form-control"
                    type="text">
            </div>
        </div>
             ...
             <div class="form-row">
                <div class="form-group col-md-6">
                 ...
                 <input type="text" value="{{ $data->judge_first_name }}" name="judge_first_name"
                 placeholder="eg Abraham" class="form-control" id="inputEmail4">
             </div>

         <div class="form-group col-md-6">
             <label for="inputPassword4">Judge Last Name</label>
             <input id="birth_date" type="text" value="{{ $data->judge_last_name }}"  name="judge_last_name"
