            ...
            <div class="row">
                ...
                @endif
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                               ...
                               <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{ old('employers_name') }}" name="employers_name"
                                placeholder="eg Richard Brandson" class="form-control" id="inputEmail4">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputEmail4">Employers Ein (number only)</label>
                                <input type="text" value="{{ old('employers_ein') }}" maxlength="9" name="employers_ein"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="inputPassword4">Applicant SSN (Number only)</label>
                            <input  type="text" value="{{ old('applicant_ssn') }}" name="applicant_ssn"
                            placeholder="231344356"  class="form-control" maxlength="9">
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input  type="text" value="{{ old('total_income') }}" name="total_income"
                                placeholder="2000.00" class="form-control" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Income Tax ($)</label>
                            <input  type="text" value="{{ old('income_tax') }}" name="income_tax"
                            placeholder="680.56" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input  type="text" value="{{ old('social_security_wages') }}" name="social_security_wages"
                                placeholder="2000.00" class="form-control" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Social Security Tax ($)</label>
                            <input  type="text" value="{{ old('social_security_tax') }}" name="social_security_tax"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input  type="text" value="{{ old('medicare_wages') }}" name="medicare_wages"
                                placeholder="2000.00" class="form-control" >
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Madicare Security Tax ($)</label>
                            <input  type="text" value="{{ old('madicare_security_tax') }}" name="madicare_security_tax"
                            placeholder="680.67" class="form-control" >
                        </div>
                    </div>
