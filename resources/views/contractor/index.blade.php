                ...
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Tax Documents:1099 Contractor</h4>
                        ...
                        <div class="alert alert-info" style="margin:15px" >
                            <p>Click 
                                ...
                                <a href="{{ asset('watermark/1099MSC.png') }}" data-lightbox="gallery-1" data-title="TAX">
                                    1099
                                </a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"> <a class="btn btn-primary float-right" data-toggle="tooltip"
                                                    ...
                                                    href="{{ asset('1099/contractor/create') }}"> Place Order<i class="fas fa-plus"></i></a> </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $value->employers_business_name }}</td>
                                            <td>{{ $value->year }}</td>
                           
                                            <td><a href="{{ asset('1099/contractor/' . $value->id . '/edit') }}"
                                                    data-toggle="tooltip" data-placement="bottom" title="edit"><i
                                                        class="fas fa-edit text-secondary"></i></a>
    
    
                                                <a href="{{ asset('1099/' . $value->id . '/delete') }}"
                                                    onclick="return confirm('Are you sure you want to delete this item?');"
                                                    class="" data-toggle="tooltip" data-placement="bottom" title="delete"><i
                                                        class="fas fa-trash text-danger"></i> </a>
                                            </td>

                                            <td>          <form method="POST" action="{{ route('contractor.create.document') }}">
                                                            @csrf
