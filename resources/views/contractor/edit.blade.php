...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Edit Tax 1040 Schedule C</h4>
                ...
                <form action="{{ route('contractor.update', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                               ...
                               <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $data->employers_business_name }}" name="employers_business_name"
                        ...
                        <div class="form-row">
                               <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $data->employers_phone }}" name="employers_phone"
                                placeholder="eg Bigwear Consultant Inc" class="form-control" id="inputEmail4">
                            </div>

                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Enter Employers EIN</label>
                            <input id="birth_date" type="text" value="{{ $xein }}" name="employers_ein"
                            placeholder="eg 312432434"  maxlength="9" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input  type="text" value="{{ $data->employers_zip}}" name="employers_zip"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input placeholder="ex.44564" type="text" value="{{ $data->applicant_zip}}" name="applicant_zip"
                                class="form-control" >
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input  type="text" value="{{ $xssn}}" name="applicant_ssn"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input  type="text" value="{{ $data->applicant_total_income}}" name="applicant_total_income"
