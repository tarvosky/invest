...
<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="widget p-md clearfix">
					<div>
						<h3 class="widget-title">DL Background Instruction</h3>
            <ul>
			...
			<div class="col-md-12">
				<div class="widget widget-pie-chart">
					<header class="widget-header">
						<h4 class="widget-title">Select DL Background</h4>
          </header>
...
$(document).ready(function() {
         $.ajax({  //create an ajax request to display.php
          type: "GET",
          url: "{{ asset('license/get-selected-background/'. $license->id )}}",       
  ...
  function reply_click(id,image)
  {
     ...
     $.ajax({
            url:"{{ asset('license/update-selected-background/'. $license->id )}}",
            type: 'post',
