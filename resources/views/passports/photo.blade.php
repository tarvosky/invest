...
<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="widget p-md clearfix">
					<div>
						<h3 class="widget-title">Passport Instruction</h3>
            <ul>
    ...
    <div class="row">
            ...
            <div class="text-center mt-5 mt-5">
              <a class="btn btn-danger btn-lg" href="{{ asset('passports')}}"> Finish >> </a>
          </div>
					</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="widget ">
            <header class="widget-header">
              <h4 class="widget-title">Young</h4>
            </header>
            <div class="widget-body">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="widget widget-pie-chart">
              <header class="widget-header">
                <h4 class="widget-title">Middle Ages</h4>
              </header>
              <div class="widget-body">
            ...
            <div class="col-md-12">
              <div class="widget widget-pie-chart">
                ...
                <div class="widget-body">
                  ...
                  <ul>
                      <li>For a good picture use 250px by 250px and make sure there is space below the jaw</li>
                  ...
                  <form method="POST" enctype="multipart/form-data" action="{{ url('passports/upload-photo') }}" >
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
    ...
    $(document).ready(function() {
             $.ajax({  //create an ajax request to display.php
              type: "GET",
              url: "{{ asset('passports/get-selected-photo/'. $passport->id )}}",       
      ...
      function reply_click(id,image)
      {
         ...
         $.ajax({
                url:"{{ asset('passports/update-selected-photo/'. $passport->id )}}",
                type: 'post',
