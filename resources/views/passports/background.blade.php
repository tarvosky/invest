			...
			<div class="col-md-12">
				<div class="widget widget-pie-chart">
					<header class="widget-header">
						<h4 class="widget-title">Select Passport Background</h4>
          </header>
...
$(document).ready(function() {
         $.ajax({  //create an ajax request to display.php
          type: "GET",
          url: "{{ asset('passports/get-selected-background/'. $passport->id )}}",       
  ...
  function reply_click(id,image)
  {
     ...
     $.ajax({
            url:"{{ asset('passports/update-selected-background/'. $passport->id )}}",
            type: 'post',
