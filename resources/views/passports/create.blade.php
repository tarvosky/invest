                ...
                <div class="col-md-12">
                    <div class="widget">
                        <header class="widget-header">
                            <h4 class="widget-title">Enter Passport Information</h4>
                    ...
                    <form method="POST" action="{{ route('passports.store') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="issued_date" value="{{ old('issued_date') }}" name="issued_date"
                                    class="form-control" type="text">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="inputZip">Birth Date</label>
                                <input id="birth_date" value="{{ old('birth_date') }}" name="birth_date" class="form-control"
                                    type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"placeholder="eg Maryland, USA"  value="{{ old('birth_place') }}" name="birth_place"
                                    class="form-control" id="inputEmail4">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Passport # (optional)</label>
                                <input type="text" placeholder="eg 938292819" value="{{ old('passport_number') }}" name="passport_number"
                                    class="form-control" >
